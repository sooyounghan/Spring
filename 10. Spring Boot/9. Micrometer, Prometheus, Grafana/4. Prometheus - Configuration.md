...
scrape_configs:
  ...
  - job_name: "spring-actuator"
    metrics_path: '/actuator/prometheus' scrape_interval: 1s
    static_configs:
...
4. 프로메테우스 연동 확인
   ...
   - 프로메테우스 연동 확인 화면
<div align="center">
<img src="https://github.com/user-attachments/assets/19d3d90d-a186-43bf-a1a8-bbecca80396e">
</div>

   - 💡 prometheus : 프로메테우스 자체에서 제공하는 메트릭 정보 (프로메테우스가 프로모테우스 자신 메트릭 확인)
...
5. 프로메테우스를 통한 데이터 조회
   - 연동한 메트릭 간단히 조회
<div align="center">
<img src="https://github.com/user-attachments/assets/1f68d573-6b8b-4d9b-981e-0a5df474298f">
</div>
