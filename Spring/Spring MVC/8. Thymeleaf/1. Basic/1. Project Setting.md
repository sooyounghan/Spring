...
-----
<div align="center">
<img src="https://github.com/sooyounghan/Spring/assets/34672301/d90e2acd-f297-4ef6-8225-b97692b9501a">
</div>

1. 동작 확인 : 기본 메인 클래스 실행(ThymeleafBasicApplication.main())
2. http://localhost:9090 호출해서 Whitelabel Error Page가 나오면 정상 동작

-----
### 홈 화면
-----
: /resouces/static/index.html
```html
<html>
<head>
    <meta charset="UTF-8">
